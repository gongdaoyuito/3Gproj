...
document.getElementById("buttonn5").onclick = function seigo4(){
    ...
    document.getElementById("buuuuuu").onclick = function sseigo3(){
        document.getElementById("kekkakekka").innerText = "正解" + seikaisuu + "問、" + "不正解" + huseikaisuu + "問";
        ...
        document.getElementById("kekkakekka").style.display = "block";
        document.getElementById("mouikkaiyaru").style.display = "block";
